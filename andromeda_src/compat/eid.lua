if EID then
	...
	EID:addTrinket(Enums.Trinkets.MOONSTONE, "{{Rune}} Chance for an extra rune or soul stone drop from opening chests, blowing up tinted rocks, and destroying slot machines#{{Rune}} Guarantees a rune/soul stone to appear in {{Planetarium}} Planetariums and the {{AbPlanetarium}} Abandoned Planetarium#Has a unique interaction with a certain item", "Moonstone")
	...
	EID:addCard(Enums.Cards.ALPHA_CENTAURI, "Consumes all items and pickups in the room#Each pickup has a 50% chance of turning into a wisp#Pedestal items are guaranteed to give 5 special wisps based on the current room", "Alpha Centauri")
	...
	EID:addGoldenTrinketMetadata(Enums.Trinkets.MOONSTONE)
	...
	EID:addCollectible(Enums.Collectibles.BABY_PLUTO, "在角色周围生成一个冥王星宝宝环绕物，发射 {{Collectible233}} 小小星球环绕眼泪 #阻挡敌人弹幕 #与{{Trinket" .. Enums.Trinkets.MOONSTONE .."}}\"月之石\"有特殊联动效果", "冥王星宝宝","zh_cn")
	...
	EID:addTrinket(Enums.Trinkets.MOONSTONE, "{{Rune}}携带该饰品时遇见符文与灵魂石的概率增加 #{{Rune}} 保证 {{Planetarium}} 星象房和 {{AbPlanetarium}} 遗弃星象房中必定出现一个符文或灵魂石 #与{{Collectible" .. Enums.Collectibles.BABY_PLUTO .."}} \"冥王星宝宝\"有特殊联动效果", "月之石","zh_cn")
