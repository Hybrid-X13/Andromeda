if EID then
	...
	EID:addCollectible(Enums.Collectibles.STARBURST, "Шанс выстрелить слезой, которая вспыхивает в наносящие урон звёзды при контакте с врагом или препятствием", "Звездообразование", "ru")
	--Брелоки
