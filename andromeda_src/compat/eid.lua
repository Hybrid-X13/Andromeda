if EID then
	...
	EID:addTrinket(Enums.Trinkets.MOON_STONE, "{{Rune}} Chance for an extra rune or soul stone drop from opening chests, blowing up tinted rocks, and destroying slot machines#{{Rune}} Guarantees a rune/soul stone to appear in {{Planetarium}} Planetariums and the {{AbPlanetarium}} Abandoned Planetarium#Has a unique interaction with a certain item", "Moon Stone")
