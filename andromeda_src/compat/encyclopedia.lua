	...
	local Wiki = {
		ANDROMEDA = {
			...
			{ -- Traits
				...
				{str = "In treasure rooms you have a choice. You can either pick up the item like normal, or you can use Gravity Shift to take you to a new room type, known as an Abandoned Planetarium."},
				{str = "This new room has a chance of containing a Zodiac item or a random reward layout."},
				{str = "Even though you might miss out on an item that floor, teleporting to the Abandoned Planetarium increases your planetarium chance for the next floor as long as you don't go back inside the treasure room."},
				{str = "There's no point in going back in the treasure room because it'll just be empty and you'll ruin your planetarium chance for the next floor."},
				{str = "The Abandoned Planetarium is Andromeda's only source of Zodiac items."},
				{str = "Collecting 4 Zodiac/Planetarium items grants Andromeda a new transformation."},
				{str = "Andromeda's shot speed can't be increased."},
				{str = "In Greed Mode, treasure rooms can't be shifted but Zodiac items can appear normally."},
			},
			{ -- Gravity Shift
				...
				{str = "The item is also Andromeda's ticket to getting more planetariums. Using it in a treasure room takes you to a new room type that potentially has a Zodiac item."},
			...
			{ -- Transformation
				{str = "Transformation", fsize = 2, clr = 3, halign = 0},
			...
			{ -- Birthright
				...
				{str = "Using Gravity Shift in treasure rooms now takes you to a real Planetarium."},
		...
		ANDROMEDA_B = {
			...
			{ -- Traits
				...
				{str = "Tainted Andromeda also has a unique way of shooting tears. They're shot out from a black hole and will curve towards where Tainted Andromeda is standing."},
			...
			{ -- Singularity
				...
				{str = "Since treasure room items can be spawned in normal rooms, it's highly recommended that you skip treasure rooms entirely to increase your planetarium chance."},
