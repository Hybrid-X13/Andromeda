	...
	local Wiki = {
		...
		ANDROMEDA_B = {
			...
			{ -- Singularity
				...
				{str = "For Planetariums, using Singularity in there for the first time will spawn a Planetarium item guaranteed. Further uses of Singularity in the room has a decreasing chance to spawn a planetarium item, similar to how secret rooms work. Otherwise it spawns a planetarium lemegeton wisp."},
				{str = "All other rooms don't have restrictions."},
				{str = "Items spawned in devil rooms and shops won't cost hearts or coins."},
				{str = "Treasure rooms are replaced with Abandoned Planetariums for Tainted Andromeda, but Singularity will spawn a treasure room item when used in any default room."},
				{str = "Using Singularity in an Abandoned Planetarium spawns a zodiac lemegeton wisp."},
		...
		PALLAS = {
			{ -- Effect
				...
				{str = "Planetariums, abandoned planetariums, libraries, secret, super secret, and ultra secret rooms add +0.6 damage. All other special rooms add +0.4 damage. Normal rooms add +0.2 damage."},
