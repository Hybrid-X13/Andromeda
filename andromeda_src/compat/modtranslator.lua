...
local B = {
  [Isaac.GetPlayerTypeByName("Andromeda",false)]={ru="Не-такое-уж-пустое Пространство",},
  [Isaac.GetPlayerTypeByName("AndromedaB",true)]={ru="Падая в пустоту",},
  }
